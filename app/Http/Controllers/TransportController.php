...
class TransportController extends Controller
{
    ...
    public function clientReqCompleted($id){
        ...
        $transport->update(['client_status'=> 'client_Completed']);
    ...
    public function transportAuth(){
        $requests= Transport::orderBy('created_at','DESC')->get();
    ...
    {   
        ...
        $drivers= driver::where('driver_status','=','Available')
    ...
    public function KIlometerUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('driver')->with('success','Kilo Meter reading entered...');
    }
    public function driverReqCompleted($id){
        ...
        $transport = Transport::where('id',$id)->update([
          ...
          $cars->update([
              ...
              'kilo_meter'=>$transports->final_kilo_meter
          ]);
